...
@section('content')
    <div class="space-y-6">
        <!-- Header Section -->
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Tambah Anggota Tim Baru</h1>
            <p class="mt-2 text-slate-600">Tambahkan anggota tim baru ke halaman About perusahaan Anda.</p>
        </div>
        ...
        <form action="{{ route('admin.tim.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="name" name="name" type="text" value="{{ old('name') }}" required class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Contoh: Budi Santoso">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="role" name="role" type="text" value="{{ old('role') }}" required class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Contoh: CEO & Pendiri">
                            </div>
                        </div>
                        ...
                        <!-- Accent Color -->
                        <div>
                            <label for="accent" class="mb-2 block text-sm font-semibold text-slate-700">Gradient Avatar *</label>
                            <select id="accent" name="accent" required class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 px-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20">
                                <option value="from-blue-500 to-indigo-600" @selected(old('accent') == 'from-blue-500 to-indigo-600')>Blue to Indigo</option>
                                <option value="from-cyan-500 to-sky-600" @selected(old('accent') == 'from-cyan-500 to-sky-600')>Cyan to Sky</option>
                                <option value="from-emerald-500 to-green-600" @selected(old('accent') == 'from-emerald-500 to-green-600')>Emerald to Green</option>
                                <option value="from-purple-500 to-violet-600" @selected(old('accent') == 'from-purple-500 to-violet-600')>Purple to Violet</option>
                                <option value="from-rose-500 to-pink-600" @selected(old('accent') == 'from-rose-500 to-pink-600')>Rose to Pink</option>
                                <option value="from-orange-500 to-red-600" @selected(old('accent') == 'from-orange-500 to-red-600')>Orange to Red</option>
                                <option value="from-amber-500 to-yellow-600" @selected(old('accent') == 'from-amber-500 to-yellow-600')>Amber to Yellow</option>
                                <option value="from-teal-500 to-emerald-600" @selected(old('accent') == 'from-teal-500 to-emerald-600')>Teal to Emerald</option>
                            </select>
                            <p class="mt-1 text-xs text-slate-500">Warna gradient untuk avatar</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="order" name="order" type="number" min="0" value="{{ old('order', 0) }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="0">
                            </div>
                        ...
                        <div>
                            ...
                            <label class="flex items-center gap-3 cursor-pointer rounded-lg border border-slate-300 bg-slate-50 p-3 transition-colors hover:border-primary hover:bg-primary/5">
                                <input type="checkbox" name="is_active" value="1" @checked(old('is_active', true)) class="h-5 w-5 rounded border-slate-300 text-primary focus:ring-2 focus:ring-primary/50">
                                <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex min-h-[180px] cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-4 text-center transition-colors hover:border-primary hover:bg-primary/5"
                                ...
                                <img id="prev_photo" src="" alt="Preview" style="max-height:120px;max-width:100%;object-fit:cover;border-radius:12px;" class="hidden">
                                <div id="ph_photo">
                                ...
                                <p id="lbl_photo" class="text-xs text-slate-400"></p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <textarea id="bio" name="bio" rows="3" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Bio singkat tentang anggota tim Anda">{{ old('bio') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" name="email" type="email" value="{{ old('email') }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="budi@bandungcoding.com">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="linkedin" name="linkedin" type="url" value="{{ old('linkedin') }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="https://linkedin.com/in/username">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="instagram" name="instagram" type="url" value="{{ old('instagram') }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="https://instagram.com/username">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="tiktok" name="tiktok" type="url" value="{{ old('tiktok') }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="https://tiktok.com/@username">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="portfolio" name="portfolio" type="url" value="{{ old('portfolio') }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="https://portofolio-saya.com">
                            </div>
                        </div>

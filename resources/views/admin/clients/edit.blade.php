...
@section('content')
    <div class="space-y-6">
        <!-- Header Section -->
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Edit Klien</h1>
            <p class="mt-2 text-slate-600">Perbarui informasi klien Anda.</p>
        </div>
        ...
        <form action="{{ route('admin.klien.update', $client) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="name" name="name" type="text" value="{{ old('name', $client->name) }}" required class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Contoh: PT Mojo Maru Indonesia">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex min-h-[140px] cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-4 text-center transition-colors hover:border-primary hover:bg-primary/5"
                                ...
                                <img id="prev_logo"
                                     src="{{ $client->logo ? asset('storage/'.$client->logo) : '' }}"
                                     alt="Preview"
                                     style="max-height:80px;max-width:100%;object-fit:contain;"
                                     class="{{ $client->logo ? '' : 'hidden' }}">
                                <div id="ph_logo" class="{{ $client->logo ? 'hidden' : '' }}">
                                ...
                                <p id="lbl_logo" class="text-xs text-slate-400">{{ $client->logo ? 'Klik untuk mengganti' : '' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <textarea id="description" name="description" rows="3" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="Deskripsi singkat tentang klien Anda">{{ old('description', $client->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" name="email" type="email" value="{{ old('email', $client->email) }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="contact@klien.com">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="phone" name="phone" type="text" value="{{ old('phone', $client->phone) }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="+62 XXX XXX XXXX">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input id="website" name="website" type="url" value="{{ old('website', $client->website) }}" class="w-full rounded-lg border border-slate-300 bg-slate-50 py-2.5 pl-10 pr-4 text-sm transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20" placeholder="https://klien.com">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                <div class="p-6">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_featured" value="1" @checked(old('is_featured', $client->is_featured)) class="h-5 w-5 rounded border-slate-300 text-primary focus:ring-2 focus:ring-primary/50">
                        <div>
